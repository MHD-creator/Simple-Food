...
export declare const createOrUpdateReview: (req: Request, res: Response) => Promise<void>;
export declare const getReviewsForPlat: (req: Request, res: Response) => Promise<void>;
